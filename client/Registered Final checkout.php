      ...
      ?>
        ...
        ?>
          ...
          <tfoot class="gray-background">
            ...
            <tr>
              <td colspan="5">Member Discount (20%)</td>
              <td>-<?= number_format($subtotal * $voucher_discount, 2) ?></td>
            </tr>
          ...
          ?>
          <a href="RegisteredplaceOrder.php" class="btn btn-primary" style="background-color: black; color: white;"><b>Place Order</b></a>
          </td>
          </tr>
         </tfoot>
          </table>
