<?php
	...
	if(isset($_POST['placeOrder']))
	{
		...
		$sql = "INSERT INTO orders (CustName, OrderProducts, OrderQty, OrderAmount, OrderPhoneNum, OrderDate, CustEmail, OrderAddress, PickupStore, OrderStatus, PaymentStatus)
		        VALUES ('$name','$OrderProducts', '$OrderQty', '$total', '$phone', '$date', '$email', '$address','$store', '$orderStatus', '$paymentStatus')";

		$result = mysqli_query($conn, $sql);

		if ($result) {
			header("Location: RegisteredOrderSuccessful.php");
		} else{
...
<main class="deliveryMain">
	...
	<form class="placeOrderForm" method="POST" action="registeredDelivery.php">
		<table>
			<tr>
				<td>
