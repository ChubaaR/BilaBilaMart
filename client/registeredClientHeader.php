<?php
    ...
    // Get all the records from the cart table based on the customer ID
    $sql = "SELECT * FROM cart WHERE CustomerID = $userID";

    // Make query and get the result
    $result = mysqli_query($conn, $sql);

    // Get the total number of rows in the cart table based on the customer ID
        ...
        <nav class="navigation">
           ...
           <!--menu-btn---->
            ...
            <ul class="menu">
                ...
                <li><a href="Registeredproducts.php">Products</a></li>
                <li><a href="RegisteredLocation.php">Locations</a></li>
            </ul>

            <!--right-nav-->
            <div class="right-nav">
                <!--cart----->
                <a href="registeredCart.php" class="cart">
                     <i class="fas fa-shopping-cart"><?php echo $numOfItem; ?></i>   
                </a>
            </div>
            <div class="right-nav">
                <a href="logout.php" class="profile" onclick="return confirm('Are you sure you want to Logout?');">
