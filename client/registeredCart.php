<?php
  ...
  if (isset($_POST['deleteAll'])) {
    ...
    if ($result) {
      ...
      echo '<script>window.location="registeredCart.php"</script>';
    }
  }
?>
    ...
    <thead>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <form method="POST" action="registeredCart.php">
              ...
              <tr>
                <td colspan="3">
                  <form method="POST" action="registeredCart.php">
                    <a href="main.php" class="btn btn-success" style="background-color: turquoise; color: white;"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Continue Shopping</a>
                ...
                <td>
                  <a style="background-color: black; color: white; "href="Registered Final checkout.php" class="btn btn-info <?= ($grandTotal > 1) ? '' : 'disabled'; ?>">Checkout</a>
                </td>
              </tr>
            </tbody>
          </table>
